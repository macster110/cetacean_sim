# Running the cetsim.jar file

runCetSim.bat is a bat file that will run the jar file with the correct vm argumnets

You must have java 8 installed for this to work, ideally version 191. You may need to change "set path"
