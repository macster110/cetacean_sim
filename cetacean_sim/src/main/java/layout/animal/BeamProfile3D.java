...
public class BeamProfile3D extends BorderPane {
	 ...
	 */
	private Function<Point3D, Number> dens =( p-> {
	...
	public SubScene create3DPane() throws Exception {
		...
		ico = new IcosahedronMesh(100f, 5); //FIXME- bug diameter does not work here so have to scale 
//		ico.setDrawMode(DrawMode.LINE);
		...
		ico.setColorPalette(Palette.DEFAULT_COLOR_PALETTE);
		// FACES
