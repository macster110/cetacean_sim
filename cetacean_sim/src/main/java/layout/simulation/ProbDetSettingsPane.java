...
public class ProbDetSettingsPane extends BorderPane {
	...
	private Pane createSidePane() {
		...
		button.setGraphic(new MaterialIconView(MaterialIcon.FILE_DOWNLOAD, "25"));
		...
		recievers.setGraphic(new MaterialIconView(MaterialIcon.SETTINGS, "25")); 
		...
		animals.setGraphic(new MaterialIconView(MaterialIcon.SETTINGS, "25")); 
