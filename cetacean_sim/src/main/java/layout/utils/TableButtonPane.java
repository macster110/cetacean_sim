...
public class TableButtonPane extends Pane {
	...
	public Text addIcon=new MaterialIconView(MaterialIcon.ADD, "25");

	
	public 	Text settingsIcon=new MaterialIconView(MaterialIcon.SETTINGS, "25");

	public 	Text deleteIcon=new MaterialIconView(MaterialIcon.DELETE, "25");
