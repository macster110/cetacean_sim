...
//	}
	...
	/**
	 * Get all colours within an array, 
	 * @return all colours within the array. 
	 */
	...
	/***
	 * Get a colour in the colour array 
	 * @param iCol - index of the colour array
	 * @return colour from the specified index
	 */
	...
	/**
	 * Get colour in the array in bounds between 0 and 1 
	 * @param col the colour between 0 and 1. 
	...
	/**
	 * Get the colour in rgb from colour array 
	 * @param iCol - the index of the colour array 
	 * @return RGB colour. 
	 */
